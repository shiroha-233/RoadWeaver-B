...
public final class NaturalDecorationSystem {
    ...
    public static void placeOnSurface(WorldGenLevel world, BlockPos placePos, List<BlockState> material, RandomSource random, ModConfig cfg) {
        SurfacePlacementUtil.placeOnSurface(world, placePos, material, 1, random, cfg);
    }
    ...
    private static int computeApproxDistanceMeters(WorldGenLevel world, BlockPos fromPos, boolean isStart, java.util.List<BlockPos> middlePositions) {
